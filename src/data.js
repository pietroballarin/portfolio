...
export const skills = [
    'JavaScript', 'React', 'NodeJS', 'Express', 'MongoDB', 'HTML5', 'CSS', 'Git & GitHub'
]

export const pitch = "I value perseverance, curiosity, and teamwork, and I am always looking for challenging projects boosting my desire for knowledge. With a background in an e-commerce startup and education, I reaped my first successes in coding by winning the hackathon and the best project award at Ironhack."